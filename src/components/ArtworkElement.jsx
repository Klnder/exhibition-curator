...
function ArtworkElement({ artwork, setArtworkClick }) {
  ...
  return (
    <div className="card card-compact min-w-[200px] w-[19%] bg-base-100 m-3 hover:scale-105 hover:shadow-md hover:shadow-secondary hover:cursor-pointer flex flex-col justify-between">
